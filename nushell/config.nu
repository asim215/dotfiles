...
# journal
# last all
alias jr = journalctl -xb
# warning
alias jr4 = jr -p 4
# errors
alias jr3 = journalctl -p 3 -xb
# critical
alias jr2 = journalctl -p 2 -xb
# alert
alias jr1 = journalctl -p 1 -xb
# emerg
alias jr0 = journalctl -p 0 -xb
# pomodoro
# alias pog = pogodoro
# translate-shell
alias ts = trans
...
alias gi = git
# yt-dlp
alias yt = yt-dlp --embed-chapters --embed-subs
# --write-auto-sub
# Weather
alias we = curl wttr.in/Kirov?T
alias we2 = curl v2.wttr.in/Kirov?T
